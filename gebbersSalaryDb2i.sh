...
java -XX:+UseG1GC -jar moqui.war load types=janedoe-gebbersSalary components=gebberssal conf=conf/MoquiDevConfDb2iPayrollGs.xml -Duser.dir=`pwd`
...
gradle runtime:component:gebberssal:test -Pconf=conf/MoquiDevConfDb2iPayrollGs.xml -Duser.dir=`pwd` # -Darg1=gebbersSalary
