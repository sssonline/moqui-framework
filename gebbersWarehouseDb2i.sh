...
java -XX:+UseG1GC -jar moqui.war load types=janedoe-gebbersWarehouse components=gebbersw conf=conf/MoquiDevConfDb2iPayrollGw.xml -Duser.dir=`pwd`
...
gradle runtime:component:gebbersw:test -Pconf=conf/MoquiDevConfDb2iPayrollGw.xml -Duser.dir=`pwd` # -Darg1=GebbersWarehouse
