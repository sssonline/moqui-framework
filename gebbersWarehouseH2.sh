...
java -XX:+UseG1GC -jar moqui.war load types=johndoe-gebbersWarehouse components=gebbers,gebbersw
java -XX:+UseG1GC -jar moqui.war load types=demo-gebbersWarehouse components=gebbers,gebbersw
gradle runtime:component:gebbersw:test -Darg1=GebbersWarehouse
