...
java -XX:+UseG1GC -jar moqui.war load types=johndoe-gebbersWarehouse components=gebbers,gebbersw conf=conf/MoquiDevConfMySQL.xml
java -XX:+UseG1GC -jar moqui.war load types=demo-gebbersWarehouse components=gebbers,gebbersw conf=conf/MoquiDevConfMySQL.xml
