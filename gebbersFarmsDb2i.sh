...
java -XX:+UseG1GC -jar moqui.war load types=janedoe-gebbersFarms components=gebbers conf=conf/MoquiDevConfDb2iPayrollGf.xml -Duser.dir=`pwd`
...
gradle runtime:component:gebbers:test -Pconf=conf/MoquiDevConfDb2iPayrollGf.xml -Duser.dir=`pwd` -Darg1=GebbersFarms
